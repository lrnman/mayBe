...
window.ArrayBuffer || document.write("<script src=/js/pwdbook/typedarray-polyfill.js><\/script>");

// If TextEncoder is not supported we include the polyfill
// https://github.com/inexorabletash/text-encoding
window.TextEncoder || document.write("<script src=/js/pwdbook/encoding-polyfill.js><\/script>");
	
// If Promise is not supported we include the polyfill
// https://github.com/taylorhakes/promise-polyfill
window.Promise || document.write("<script src=/js/pwdbook/promise-polyfill.js><\/script>");

// If setImmediate is not implemented we include the polyfill
window.setImmediate || document.write("<script src=/js/pwdbook/" + esdir + "setImmediate-polyfill.js><\/script>");

// Include the scrypt implementation
document.write("<script src=/js/pwdbook/" + esdir + "mpw-js/pbkdf2.js><\/script>");
document.write("<script src=/js/pwdbook/" + esdir + "mpw-js/scrypt.js?1><\/script>");

// Include the MPW class
document.write("<script src=/js/pwdbook/" + esdir + "mpw-js/mpw.js?1><\/script>");
